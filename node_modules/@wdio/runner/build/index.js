...
class Runner extends events_1.EventEmitter {
    ...
    async run({ cid, args, specs, caps, configFile, retries }) {
        ...
        await utils_1.executeHooksWithArgs('beforeSession', this._config.beforeSession, [this._caps, this._specs]);
    ...
    async endSession() {
        ...
        await utils_1.executeHooksWithArgs('afterSession', global.browser.config.afterSession, [capabilities, this._specs]);
    }
}
